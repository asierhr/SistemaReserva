...
public class HotelReservationController {
    ...
    public HotelReservationDTO createReservation(@PathVariable Long id, @RequestBody List<Long> roomIds){
        return hotelReservationService.createReservation(id, roomIds);
    }
}
